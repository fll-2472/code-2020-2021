...
def run_3():
  ...
  follow_line_distance_right(-200, 700)
  ...
  straight_line_distance(-60, -100, 100)
  turn(-190, 2)
  right_mission_motor.run_time(200, 1500)
  straight_line_distance(-205, 100, 70)
  straight_line_distance(-205, -500, 200)
  straight_line_distance(-195, 100, 190)
  straight_line_distance(-180, -100, 100)
  follow_line_distance_left(-100, 250)
