...
def run_4():
    ...
    straight_line_distance(-30, -100, 150)
    turn(-90, 2)
    straight_line_distance(-90, -100, 120)
    straight_line_distance(-90, 100, 78)
    turn(-120, 2)
    wait(100)
    straight_line_distance(-130, -130, 188)
    right_mission_motor.run_time(-400, 4500)
    right_mission_motor.run_time(2000, 1000)
    straight_line_distance(-130, 150, 130)
    turn(-220, 2)
    straight_line_distance(-220, 170, 355)

    while True:
        straight_line_distance(-220, 100, 20)
        straight_line_distance(-220, -100, 20)
        straight_line_distance(-220, 100, 40)
        straight_line_distance(-220, -100, 40)
